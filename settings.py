...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'kKpins91Ksutvn',                  # Not used with sqlite3.
...
SECRET_KEY = 'r*ccq+cjnbkgmfhs#@c8=a#b+0*x%or&9h@j1u($=t$sap3g2@'
...
#TEMPLATE_DIRS = ('/Users/freebsdstuff/PycharmProjects/ecomstore/templates',)
TEMPLATE_DIRS = (str(os.path.abspath(os.path.dirname(__file__).decode('utf-8'))) + "/templates",)
